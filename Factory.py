from MVC.Model.Student import Student
from MVC.Model.Group import Group
from MVC.Model.Subject import Subject
from MVC.Controller.Support.CheckInput import check_input_on_empty
from MVC.Controller.Support.Convert import convert_input_to_int
